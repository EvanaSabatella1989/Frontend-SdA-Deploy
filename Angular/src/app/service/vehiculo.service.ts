...
export class VehiculoService {
  ...
  agregarVehiculo(vehiculoData: any): Observable<any> {
    return this.http.post(`${this.apiUrl}/vehiculo/agregar/`, vehiculoData);
  }

  getVehiculo(id: number): Observable<any> {
    return this.http.get(`${this.apiUrl}/vehiculo/${id}/`);
  }

  editarVehiculo(id: number, vehiculoData: any): Observable<any> {
    return this.http.put(`${this.apiUrl}/vehiculo/${id}/`, vehiculoData);
  }
